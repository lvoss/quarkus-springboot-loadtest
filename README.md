...
Once started, access the endpoint:

```bash
curl http://localhost:8080/prime-calculation?startNumber=10000000000000&count=200
```
...
You can then execute your native executable with: `./target/quarkus-loadtest-1.0.0-SNAPSHOT-runner`
